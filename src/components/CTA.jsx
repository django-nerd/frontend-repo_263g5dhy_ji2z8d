        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 md:p-12 shadow-xl relative overflow-hidden">
          ...
          <div className="max-w-3xl relative">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-6 grid gap-3 sm:grid-cols-[1fr_auto]">
              <input type="email" required placeholder="Seu e-mail" className="w-full rounded-xl border border-slate-300 px-4 py-3 outline-none focus:ring-2 focus:ring-blue-600 bg-white" />
              <button className="rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 px-6 py-3 font-semibold text-white shadow-lg shadow-blue-600/30">Criar conta</button>
            </form>
