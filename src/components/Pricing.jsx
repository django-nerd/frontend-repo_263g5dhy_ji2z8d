    ...
    <section id="pricing" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border border-blue-200 bg-gradient-to-b from-white to-blue-50 p-6 shadow-sm ring-1 ring-blue-500/10">
            <p className="text-sm font-semibold text-blue-700">Profissional</p>
            ...
            <a href="#cta" className="mt-6 inline-flex w-full justify-center rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 px-4 py-2 font-semibold text-white shadow-lg shadow-blue-600/30">Assinar</a>
          </div>
